            ...
            <Col span="4" offset="2">
              <div class="type">
                <span v-if="item.contestType === 'SECRET_WITH_PASSWORD'"
                  ><Icon type="md-unlock" color="#515a6e" />私有赛(可加入)</span
                >
                <span v-else-if="item.contestType === 'PUBLIC'"
                  ...
                  />公开赛</span
                >
                <span v-else-if="item.contestType === 'SECRET_WITHOUT_PASSWORD'"
                  ><Icon
                    type="md-lock"
                    color="#515a6e"
                  />私有赛(不可加入）</span
            ...
            <Col span="4" offset="3">
              <div class="status">
                ...
                <span v-else-if="item.status === 'ENDED'" class="text"
                  ...
                  />已结束</span
                >
                <span v-else="item.status === 'NOT_STARTED'" class="text"
                  ><Icon type="ios-cafe" color="#19be6b" />即将开始</span
                >
              </div>
            </Col>
          </Row>
