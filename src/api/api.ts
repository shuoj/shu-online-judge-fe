...
export default {
  ...
  getContestProblemsDetail: (data: { cid: string, pid: string }) => axios.get(`/api/v1/contests/${data.cid}/problems/${data.pid}`),
  ...
  getProblemsIdByTitle: (data: {}) => axios.get('/api/v1/problems', { params: data }),
