<template>
  <div>
    ...
    <Row class="item-padding" style="vertical-align: middle;text-align: left;margin-bottom: 50px;">
      <Col span="10" offset="1">
        <h2 style="padding-bottom: 20px;">导入小组成员（已经添加的可以不用再选）</h2>
      </Col>
      <Col span="2">
        <Button type="primary" @click="addGroupsToContest">添加</Button>
      </Col>
      <Col span="22" offset="1">
        <CheckboxGroup v-model="groupAdd" v-for="(item, index) in groups" :key="item.id">
