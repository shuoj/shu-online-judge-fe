    ...
    <Col span="24" align="left" >
      ...
      <Row>
        <Col span="24" style="margin-bottom: 40px">
          ...
          <div class="publish-part">
            <h4>内容</h4>
            <vue-wangeditor style="text-align: left" id="editor" :options="options" v-model="content" :init-content="initContent" :text.sync="text"></vue-wangeditor>
          </div>
          <Button :class="classA" @click="publish()" :disabled="this.disabledA">发布</Button>
          <Button :class="classB" @click="revise()" :disabled="this.disabledB" style="margin-left: 10px;">修改</Button>
        </Col>
      </Row>
    </Col>
  </Row>
