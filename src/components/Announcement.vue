<template>
  <Row>
    <Col span="16" offset="4" style="padding-top: 40px">
      <div class="paddingTop" v-for="(announcement, index) in announcements" :key="index">
        <h1>{{announcement.title}}</h1>
        <p><span>作者：{{announcement.authorName}}</span><span>创建时间：{{announcement.modifiedDate}}</span></p>
