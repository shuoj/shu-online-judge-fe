<template>
  <Row style="padding-top: 40px;">
    ...
    <Col span="20" offset="2">
      <Tabs value="problem" style="padding-top: 40px;" v-on:on-click="getSubmission">
        <TabPane label="题目" name="problem">
          ...
          <div>
            ...
            <div style="display: flex;justify-content: left;">
              <Button type="primary" @click="hideInfo" v-if="!hide">查看隐藏信息</Button>
            </div>
          ...
          <Card v-if="codeStatus" class="pro-status">
            Run Code Status: <span :style="{color: codeColor}">{{codeStatus}}</span>&nbsp;&nbsp;<a
